...
Example test_nandb5:
  (nandb true true) = (nandb2 true true).
Proof. simpl. unfold nandb. simpl. reflexivity. Qed.
Example test_nandb6:
  (nandb true false) = (nandb2 true false).
Proof. simpl. unfold nandb. simpl. reflexivity. Qed.
(** [] *)
...
Example test_andb5:
  (andb3 true true false) = (andb4 true true false).
Proof. reflexivity. Qed.
Example test_andb6:
  (andb3 true true false) = (andb4 true true false).
Proof. reflexivity. Qed.
...
Example test_factorial3:          (factorial 5) = (factorial2 5).
Proof. simpl. reflexivity. Qed.
(** [] *)
