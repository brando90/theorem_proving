...
Fixpoint ble_nat2 (n m : nat) : bool :=
  match m -  n with
    | S delta => true
    | 0 =>
      match n - m with
...
Compute 2 - 4.  (* note: 2 - 4 = 0 but 4-2 = 2 *)
...
Example check_ble_nat11:
  (ble_nat2 2 2 ) = (ble_nat 2 2).
Proof. simpl. reflexivity. Qed.
Example check_ble_nat12:
  (ble_nat2 2 4 ) = (ble_nat 2 4).
Proof. simpl. reflexivity. Qed.
Example check_ble_nat13:
  (ble_nat2 4 2 ) = (ble_nat 4 2).
Proof. simpl. reflexivity. Qed.
...
Example check_blt_nat11:
  (blt_nat2 2 2 ) = (blt_nat 2 2).
Proof. simpl. reflexivity. Qed.
Example check_blt_nat12:
  (blt_nat2 2 4 ) = (blt_nat 2 4).
Proof. simpl. reflexivity. Qed.
Example check_blt_nat13:
  (blt_nat2 4 2 ) = (blt_nat 4 2).
Proof. simpl. reflexivity. Qed.
...
(*
Theorem identity_fn_applied_twice_mine :
  forall (f : bool -> bool), 
  forall (x : bool),
  forall (b : bool), 
  f x = x -> f (f b) = b.
